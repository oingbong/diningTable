...
<body>
	...
	<form action="insertReservation.do" method="post" class="form-inline"> <!-- 인라인 폼 -->

		<p>
			<div class="form-group">
				<label>예약 날짜</label>
				<input type="text" name="rDate" id="rDate" value="" class="form-control">
			</div>
		</p>
		...
		<p>
			<div class="form-group">
				<label>인원수</label>
				<input type="text" name="rNumber" id="rNumber" value="" class="form-control">
			</div>
		</p>
		...
		<p>
			<div class="form-group">
				<label>요구사항</label>
				<textarea name="rRequest" id="rRequest" rows="5" cols="60" class="form-control"></textarea>
			</div>
		</p>
		...
		<p>
			<div class="form-group">
				<label>회원번호</label>
				<input type="text" name="mNo" id="mNo" value="${m.mNo }" readonly="readonly" class="form-control">
			</div>
		</p>
		...
		<p>
			<div class="form-group">
				<label>레스토랑 번호</label>
				<input type="text" name="tNo" id="tNo" value="${t.tNo }" readonly="readonly" class="form-control">
			</div>
		</p>
